...
namespace Employees.Controler
{
    ...
    public class ServiceControler //: IObservable<ServiceControler>
    {
        #region event
        ...
        private static ServiceControler _singleton=null;
        public static ServiceControler Instance
        {
            get
            {
        ...
        public Service addService(string code, string label,addServiceDelegate fn = null)
        {
            ...
            try
            {
                this.Services.Add(service = new Service(code, label));
            }
            catch (Exception e)
            {
                throw e;
        ...
        public void updateService(Service service,string code,string label)
        {
            ...
            evtUpdateService(service, EventArgs.Empty);
            this.sort();
        }
